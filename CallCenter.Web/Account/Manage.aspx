<%@ Page Title="Manage Account" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="CallCenter.Web.Account.Manage" %>
...
<asp:Content ContentPlaceHolderID="MainContent" runat="server">
    ...
    <section id="passwordForm">
        ...
        <p>Estás logedo como <strong><%: User.Identity.Name %></strong>.</p>
